...
function validateAll(e) {
    ...
    axios.post('/topics/validate', data).then(function (response) {
        ...
        var PrecioIncorrecto = gestionarErrores($("#category"), response.data["category"]);
        var DescripcionIncorrecto = gestionarErrores($("#content"), response.data["content"]);
...
function validate(field) {
    ...
    axios.post('/products/validate', data).then(function (response) {
